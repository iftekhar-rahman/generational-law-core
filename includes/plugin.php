...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Generation_Law_Addon\Plugin The single instance of the class.
	 */
	...
	public function my_plugin_frontend_stylesheets() {
		...
		wp_register_style( 'gn-socials-css', plugins_url( '/assets/css/gn-socials.css', __FILE__ ) );

		wp_enqueue_style( 'gn-socials-css' );
	...
	public function my_plugin_frontend_scripts() {
		...
		// wp_register_script( '', plugins_url( '/assets/js/', __FILE__ ), [ 'jquery' ], '', true );
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'gn-law',
			[
				'title' => esc_html__( 'GN Law Group', 'generational-law-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/gn-socials.php' );

		$widgets_manager->register( new \Generation_Law_Addon\GN_Socials() );
